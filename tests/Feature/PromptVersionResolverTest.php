...
test('each prompt stage resolves its current version', function (AiStage $stage, string $version) {
    ...
    'planner' => [AiStage::Planner, 'chapter-planner-v1'],
    'writer' => [AiStage::Writer, 'scene-writer-v1'],
    'assembler' => [AiStage::Assembler, 'assembler-v1'],
...
test('ai requests retain the resolved prompt version for run tracking', function () {
    ...
    expect($request->promptVersion)->toBe('chapter-planner-v1');
});
