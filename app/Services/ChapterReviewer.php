...
class ChapterReviewer
{
    ...
    public function review(int $chapterId, bool $regenerate = false, ?string $operationId = null): ?Review
    {
        ...
        $context['generation_preferences']['review_token_budget'] = [
            'initial_max_completion_tokens' => (int) config('generation.review_max_output_tokens', 4_000),
            'retry_max_completion_tokens' => (int) config('generation.review_retry_max_output_tokens', 8_000),
            'final_retry_max_completion_tokens' => (int) config('generation.review_final_retry_max_output_tokens', 12_000),
        ];
