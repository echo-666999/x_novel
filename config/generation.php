...
return [
    ...
    'review_retry_max_output_tokens' => (int) env('REVIEW_RETRY_MAX_OUTPUT_TOKENS', 8_000),
    'review_final_retry_max_output_tokens' => (int) env('REVIEW_FINAL_RETRY_MAX_OUTPUT_TOKENS', 12_000),
    ...
    'rewrite_retry_max_output_tokens' => (int) env('REWRITE_RETRY_MAX_OUTPUT_TOKENS', 16_000),
