...
return [
    ...
    'tenses' => ['past' => '过去时', 'present' => '现在时'],
    'subgenres' => [
        'eastern_fantasy' => '东方玄幻',
        'immortal_cultivation' => '仙侠修真',
        'high_martial_arts' => '高武世界',
        'mythic_fantasy' => '神话幻想',
        'western_fantasy' => '西方奇幻',
        'sword_and_magic' => '剑与魔法',
        'epic_fantasy' => '史诗奇幻',
        'urban_life' => '都市生活',
        'urban_supernatural' => '都市异能',
        'workplace_business' => '职场商战',
        'entertainment_industry' => '娱乐圈',
        'youth_campus' => '校园青春',
        'crime_investigation' => '刑侦',
        'detective_mystery' => '推理探案',
        'folk_supernatural' => '民俗灵异',
        'rule_horror' => '规则怪谈',
        'horror_thriller' => '恐怖惊悚',
        'space_science_fiction' => '星际科幻',
        'future_technology' => '未来科技',
        'cyberpunk' => '赛博朋克',
        'post_apocalyptic' => '末世灾变',
        'alternate_history' => '架空历史',
        'court_intrigue' => '宫廷权谋',
        'military_war' => '战争军事',
        'modern_romance' => '现代言情',
        'historical_romance' => '古代言情',
        'marriage_romance' => '婚恋情感',
        'family_drama' => '家庭伦理',
        'virtual_game' => '虚拟网游',
        'esports' => '电竞竞技',
        'game_world' => '游戏异界',
        'slice_of_life_fantasy' => '日常幻想',
        'youth_romance' => '青春恋爱',
        'otherworld_adventure' => '异世界冒险',
    ],
